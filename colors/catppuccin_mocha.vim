...
call s:hi("SpellBad", "NONE", s:red, "NONE", "bold,underline", "bold,underline")
call s:hi("SpellCap", "NONE", s:yellow, "NONE", "bold,underline", "bold,underline")
call s:hi("SpellLocal", "NONE", s:blue, "NONE", "bold,underline", "bold,underline")
call s:hi("SpellRare", "NONE", s:green, "NONE", "bold,underline", "bold,underline")
